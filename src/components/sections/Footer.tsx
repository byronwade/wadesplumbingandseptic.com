...
const navigation = {
	main: [
		...
		{ name: "Expert Tips", href: "/expert-tips" },
		{ name: "Jobs", href: "/about-us/jobs" },
	...
	social: [
		{
			name: "Facebook",
			href: "https://www.facebook.com/wadesplumbingandseptic/andseptic/",
			icon: (props) => (
		...
		{
			name: "Instagram",
			href: "https://www.instagram.com/wadesplumbing/?hl=en",
			icon: (props) => (
				<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
					<path
						fillRule="evenodd"
