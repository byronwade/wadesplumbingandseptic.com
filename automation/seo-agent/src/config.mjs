...
const envSchema = z
	.object({
		...
		SEO_AGENT_ENABLE_DATAFORSEO: z.enum(["true", "false"]).optional(),
...
export function loadConfig(env = process.env) {
	...
	return Object.freeze({
		...
		integrationFlags: Object.freeze({
			...
			dataForSeo: raw.SEO_AGENT_ENABLE_DATAFORSEO === "true",
		...
		credentials: Object.freeze({
			...
			dataForSeoLogin: raw.DATAFORSEO_LOGIN,
			dataForSeoPassword: raw.DATAFORSEO_PASSWORD,
...
export function summarizeConfig(config) {
	return Object.freeze({
		...
		integrations: Object.freeze({
			...
			dataforseo: Boolean(
				config.credentials.dataForSeoLogin &&
				config.credentials.dataForSeoPassword,
			),
