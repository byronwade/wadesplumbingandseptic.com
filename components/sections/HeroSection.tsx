	...
	return (
		...
		>
			...
			<section className="z-30 relative overflow-hidden">
				{/* <div className="flex flex-row text-white justify-between w-1/2 mx-auto">
					<Link href="/">Service Work</Link>
					<Link href="/">Commercial</Link>
					<Link href="/">Septic</Link>
				</div> */}
				...
				<div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-12 xl:gap-0 lg:py-24 lg:grid-cols-12">
					<div className="z-10 place-self-center mr-auto mb-10 lg:col-span-7 xl:col-span-8 xl:mb-0 p-4 m:p-6 lg:p-8">
						...
						<p className="mt-6 text-md md:text-lg leading-6 md:leading-8 text-white backdrop-blur-sm bg-white/10 p-4 rounded">
