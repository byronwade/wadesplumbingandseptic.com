		...
		<section className="bg-white relative overflow-hidden">
			<div className="py-16 px-6 sm:py-24 lg:px-8">
				<div className="mx-auto max-w-7xl">
					<h2 className="text-lg font-semibold leading-8 tracking-tight text-brand-700">Frequently asked questions</h2>
					...
					<p className="max-w-2xl text-lg leading-6 text-gray-700">
						...
						<Link onClick={() => track("FAQ - Send Us an Email")} href="/contact-us" className="font-semibold text-brand-700 hover:text-brand-500">
							{` `}sending us an email{` `}
						</Link>
