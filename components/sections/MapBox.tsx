...
mapboxgl.accessToken = "pk.eyJ1IjoiYnlyb253YWRlIiwiYSI6ImNqOG9xdzJ4djA3c3AzM3J6ZWRyemNoczAifQ.YdEsyaOK8qvPGZ8eU43W4g"; // Replace with your Mapbox access token
...
const ServiceAreaMap = () => {
	...
	useEffect(() => {
		const map = new mapboxgl.Map({
			...
			center: [-121.955235, 36.974117], // Centered roughly around the three counties
			zoom: 8,
			interactive: false, // This disables all map interactions
			attributionControl: false, // This removes the attribution control
		});

		map.on("load", () => {
			// Mock GeoJSON data for the service areas
			const serviceArea = {
			...
			map.addLayer({
				...
				layout: {},
				paint: {
					"fill-color": "#ff0000", // Red fill color for the service area
			...
			map.addLayer({
				...
				layout: {},
				paint: {
					"line-color": "#ff0000", // Red line color for the service area outline
					"line-width": 2,
				},
			});
		});
	...
	return <div ref={mapContainerRef} className="map-container absolute top-0 right-0" style={{ height: "100%", width: "113%" }} />;
};
