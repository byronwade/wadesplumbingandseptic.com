...
import { X, Minus, Plus, Locate, Maximize, Loader2 } from "@/components/icons";
...
// Check the document for an explicit light/dark class or data attribute.
// Covers both `class="dark"` and `data-theme="dark|light"`.
...
function useResolvedTheme(themeProp?: "light" | "dark"): Theme {
  ...
  useEffect(() => {
    ...
    // Watch for document theme class / data-theme attribute changes.
...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-ring hover:bg-muted text-foreground absolute top-2.5 right-2.5 z-10 inline-flex size-8 cursor-pointer items-center justify-center rounded-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset"
    >
      <X className="size-4" />
    </button>
  );
