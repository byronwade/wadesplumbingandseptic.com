...
function MarkerPopup({
	...
	return createPortal(
		<div
			className={cn(
				"bg-popover text-popover-foreground relative max-w-sm rounded-lg border p-5 font-sans text-base leading-relaxed font-normal tracking-normal antialiased shadow-md",
